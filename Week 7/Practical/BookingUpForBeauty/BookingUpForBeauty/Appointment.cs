...
namespace BookingUpForBeauty
{
    public static class Appointment
    {
        ...
        public static DateTime Schedule(string appointmentDateDescription)
        {
            ...
            return new DateTime(
                DateTime.Parse(appointmentDateDescription).Year,
                DateTime.Parse(appointmentDateDescription).Month,
                DateTime.Parse(appointmentDateDescription).Day,
                DateTime.Parse(appointmentDateDescription).Hour,
                DateTime.Parse(appointmentDateDescription).Minute,
                DateTime.Parse(appointmentDateDescription).Second);
